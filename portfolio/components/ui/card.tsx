...
const Card: React.FC<CardProps> = ({
    ...
    return (
        <div className="h-screen p-4 sm:p-8 md:p-20 flex items-center justify-center sticky top-0">
            ...
            <motion.div style={{ scale: cardScale, top: `calc(-10% + ${index * 5}vh)` }} className="relative -top-[10%] w-full max-w-5xl h-auto aspect-video p-2 sm:p-4 bg-[#F4F4F5] dark:bg-zinc-900 border border-zinc-300 dark:border-zinc-700 rounded-xl grid grid-cols-1 lg:grid-cols-2 gap-4">
