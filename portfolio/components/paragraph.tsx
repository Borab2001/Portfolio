...
const Paragraph: React.FC = () => {
    ...
    const text = `I’m a software engineer and designer based in Paris, with nearly four years of experience crafting digital products. Currently working as a freelancer, I bring together technical expertise and a strong eye for design to build interfaces that are not only functional but also meaningful and visually refined.<br />Inspired by elegance and minimalism, I draw from the aesthetics of Paris, its black-and-white contrasts found in fashion and design, its sense of detail, and its timeless balance between clarity and sophistication. I believe technology should not only be easy to use, but also a pleasure to use, creating experiences that feel natural, simple, and enjoyable.<br />Whether I’m designing, coding, or capturing moments with my polaroid, I’m guided by curiosity, memory and an attention to detail, qualities that keep teaching me to stay open, take risks, and explore new perspectives.`;
