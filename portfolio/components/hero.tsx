        ...
        <div className="min-h-dvh w-full p-4 sm:p-8 md:p-20 flex flex-col smooth-height">
            <div className="flex-1 h-full flex flex-col items-center justify-center gap-4 sm:gap-6 md:gap-8">
                <Image 
                    ...
                    width={128}
                    height={128}
                    className=" h-24 w-24 sm:h-32 sm:w-32 rounded-full shadow-sm shadow-primary ring-1 ring-primary"
                    priority
                />
                ...
                <p className="text-lg sm:text-xl md:text-2xl leading-relaxed tracking-tight text-secondary max-w-96 md:max-w-lg text-center">
                    A French engineer & designer who finds emotion in design and crafts with a keen eye
                </p>
            </div>
